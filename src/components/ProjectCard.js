...
export default function ProjectCard({ tech, desc, live, repo, name, img }) {
  return (
    <div
      className="md:w-[24rem] w-[20rem] h-[11rem] bg-blue-100 hover:bg-emerald-100 hover:cursor-pointer 
      hover:scale-105 transition-all delay-200 ease-in-out border-2 border-black rounded-lg"
    >
      <div className="flex flex-col p-4 justify-evenly md:space-y-2  rounded-md">
        <div className="flex flex-row items-center py-1 gap-2 justify-between">
          ...
          <div className="flex gap-2">
            <Link href={repo} target="_blank">
              <Icon icon="uil:github" className="w-8 h-8 hover:text-blue-800" />
            </Link>
        ...
        <div className="flex flex-row items-center">
          <Icon
            ...
            className="text-orange-600 text-4xl font-extrabold"
          />
